...
public class MainActivity extends Activity implements IInterface.Callback<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn1).setOnClickListener(v -> valueClick.onOkClick());
        ...
        findViewById(R.id.btnGenJacoco).setOnClickListener(v -> JacocoHelper.INSTANCE.generateCoverageFile(MainActivity.this));
