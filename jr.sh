...
reportSdCardPath="storage/emulated/0/Android/data/com.didichuxing.tools.droidassist/cache/aa.ec"
adb pull $reportSdCardPath "$toDir"

echo ""
echo "======step2:执行gradle task:jacocoTestReport生成html (jacoco.gradle)"
rm -rf "$projectDir/sample/build/reports/jacoco"
./gradlew jacocoTestReport
reportPath="$projectDir/sample/build/reports/jacoco/jacocoTestReport/html/index.html"
